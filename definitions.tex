...
\item $b\in \ssib[\cM]{a,x}$. It follows that $\trip ybx\in \cM$ such that $\parent x\parentof y$ and $k;d_w=b^I;u_x;a^P$ for some $k\of I_y\to I_x$.\todo{AR: This proof cannot completed without a radical change to the statement of the lemma, as there is no way to work in the parent of $v$}
\end{itemize}
\end{proof}
