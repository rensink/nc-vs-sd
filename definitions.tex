...
\begin{itemize}
\item a set $\tp$ of triples $(v,a,w)$ where $(v,w)\in (V_\cT\times V_\cU) \cup (V_\cU\times V_\cT)$\todo{AC: changed back\\ {AR: note that triples can occur within a single tree; this is required for the sibling rule}} and $a\of d_v\to d_w$ is an open graph morphism;
