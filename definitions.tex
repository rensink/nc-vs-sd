...
\centering
\input{figs/triple}
\caption{Visualisation of a triple $\trip vaw$ as in \cref{def:morphism}. The blue ellipses are the open graphs corresponding to nodes of $\cT$ and $\cU$. For the root triple, $I_v=I_w=I$ and $a\I=\id_I$}
\label{fig:triple}
\end{figure}
