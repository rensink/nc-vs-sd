...
\item There are $y_3\childof y_2$ and $\trip{y_3}{b_3}{z_1}\in \rgen_\cZ$ such that $(y_1,y_3)\vpattern[k]{b_1}{b_3} z_1$. This gives rise to the diagram
%
\def\mypattern{
\node (Iy1) {};
\node (Py1) [below=of Iy1] {};
...
\Cref{lem:interface flexibility} therefore implies that the open graph morphism $e$ with $e\I=\bar s;k;a\I_2$ and  $e\P=\bar d\P$ satisfies $\trip {v}{e}{x_2}\in \rgen_\cM$. We may therefore take, without loss of generality, choose $\bar d$ to equal this $e$; i.e., we may assume $\bar d\I=\bar s;k;a\I_2$.
...
\medskip\noindent\emph{Clause~\ref{xpattern}.} There is then a $\trip{y_2}{a_2}{x_2}\in \rgen_\cM$ such that $(x_1,x_2)\xpattern{a_1}{a_2} (y_1,y_2)$; hence $a_2$ and $b_1$ form the diagram of \ref{eq:composition induction premisse}. \Cref{lem:composition induction} implies that this can be extended to one of the diagrams of \ref{eq:composition induction result}.
