...
\begin{definition}[properties of arrows of $\CT$]
...
\begin{proposition}[relations among properties of $\CT$ arrows]
...
\begin{proposition}[functors among categories of condition trees]
...
\begin{definition}[path category of condition trees]
...
We extend now the properties of Definition \ref{def:prop-rfl-prs} to arrows of $\CT^*$.
