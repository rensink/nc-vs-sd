...
Summarizing, for a formula in context $\ctx{X}{\phi}$ we define the corresponding nested condition $\cT_\phi$ with root $\tupof{X}$ \todo{AC: Denote it everywhere as $\cT_\phi \of \tupof{X}$?} inductively as follows:
